...
cd /d "D:\developement\My Github\PrivateSchoolManagement\LaravelBackEnd"
start php artisan serve

:: Start Node.js (Express Server)
echo Starting Express project...
cd /d "D:\developement\My Github\PrivateSchoolManagement\ExpressBackEnd"
start node ./src/server.js

:: Start React (npm run dev)
echo Starting React project...
cd /d "D:\developement\My Github\PrivateSchoolManagement\ReactFrontEnd"
start npm run dev
