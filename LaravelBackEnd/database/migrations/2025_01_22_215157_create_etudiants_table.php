...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::create('etudiants', function (Blueprint $table) {
            // Student Information
            $table->string('matriculeEt', 22)->primary();
            $table->string('PROFILE_PICTUREEt', 50);
            $table->string('GENREEt', 1)->check("GENREEt IN ('H', 'F')");
            ...
            $table->integer('CODE_POSTALEt')->check('CODE_POSTALEt >= 1000 AND CODE_POSTALEt <= 99999');
